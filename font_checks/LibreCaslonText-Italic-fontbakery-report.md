...
|  | fonts/LibreCaslonText-Italic.ttf |
|:--- | ---:|
| Dehinted Size | 83.8kb |
| Hinted Size | 83.4kb |
| Increase | -424 bytes |
| Change   | -0.5 % |
...
* :information_source: **INFO** This font contains the following optional tables [prep, GPOS, gasp, DSIG, loca, GSUB]
...
* :bread: **PASS** fonts/LibreCaslonText-Italic.ttf is named canonically.
